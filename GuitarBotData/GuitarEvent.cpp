...
{
	if (notes.size() == 1) return TC_PICK;
	return TC_STRUM;
}
...
{
	string str = "chord :: tick = " + to_string(tick) + ", m = " + to_string((tick/1920) + 1) + ", technique = " + (getTechniqueClass() == TC_STRUM ? "strum" : "pick");
